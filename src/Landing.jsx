  ...
  return (
    <>
      ...
      >
        ...
        <div className=" p-4  z-50    bg-slate-900  lg:flex  ">
          <p className="text-9xl text-yellow-300 font-Italiana">Q</p>
          <div className="flex-col my-auto">
            <p className="font-Italiana  flex">
              <p className="my-auto opacity-75 text-4xl">uilon Beach Hotel</p>
            </p>
